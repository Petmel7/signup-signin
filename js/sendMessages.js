...
socket.onmessage = async function (event) {
    ...
    } else if (messagesData.action) {
        console.log('messagesData.action', messagesData.action)
        const messages = messagesData.action.messages;
        const users = messagesData.action.users;
...
// } else if (messagesData.action === 'update' && messagesData.message_id && messagesData.message_text) {
//     const messages = messagesData.delete.messages;
//     const users = messagesData.delete.users;
...
//     updateMessageInUI(messagesData.message_id, messagesData.message_text);
//     await displayMessages(messages, users);
// }


// function updateMessageInUI(messageId, messageText) {
//     // Logic to update the message in the UI based on messageId and new messageText
// }