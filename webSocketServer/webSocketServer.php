...
$ws_worker->onMessage = function ($connection, $data) use (&$connectedUsers, &$connectionUserMap) {
    ...
    } elseif ($message['action'] === 'update' && isset($message['message_id'], $message['message_text'])) {
        $messageId = $message['message_id'];
        $messageText = $message['message_text'];
...
//         if ($message['action'] === 'update' && isset($message['message_id'], $message['message_text'])) {
//             $messageId = $message['message_id'];
//             $messageText = $message['message_text'];
...
//                 }
//             }
//         } elseif ($message['action'] === 'delete' && isset($message['message_id'])) {
//             $messageId = $message['message_id'];
